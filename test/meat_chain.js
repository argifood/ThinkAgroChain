...
contract('MeatSupplyChain', function(accounts) {
	...
	describe("Breeding Activities",() => {

		var batchNo = false;

		it("should add breeding basic details",async() => {
		...
		it("should get breeding basic details",async() => {
		...
		it("should set breeding inspection details",async() => {

			/* Prepare Breed Inspector */
		...
		it("should get vet inspection details",async() => {
		...
		it("should update slaughter details",async() => {
